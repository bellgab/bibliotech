<?php $__env->startSection('title', 'Könyv szerkesztése'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Könyv szerkesztése: <?php echo e($book->title); ?></h4>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description" name="description" rows="4"><?php echo e(old('description', $book->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="published_year" name="published_year" value="<?php echo e(old('published_year', $book->published_year)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="total_copies" name="total_copies" value="<?php echo e(old('total_copies', $book->total_copies)); ?>" 
                                       min="1" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="available_copies" name="available_copies" value="<?php echo e(old('available_copies', $book->available_copies)); ?>" 
                                       min="0" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('books.show', $book)); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/books/edit.blade.php ENDPATH**/ ?>