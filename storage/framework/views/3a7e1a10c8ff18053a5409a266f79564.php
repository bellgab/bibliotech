<?php $__env->startSection('title', 'Új felhasználó'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Új felhasználó hozzáadása</h4>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="member" <?php echo e(old('role') == 'member' ? 'selected' : ''); ?>>Tag</option>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assign-librarian')): ?>
                                        <option value="librarian" <?php echo e(old('role') == 'librarian' ? 'selected' : ''); ?>>Könyvtáros</option>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assign-admin')): ?>
                                        <option value="admin" <?php echo e(old('role') == 'admin' ? 'selected' : ''); ?>>Adminisztrátor</option>
                                    <?php endif; ?>
                                </select>
