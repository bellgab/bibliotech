<?php $__env->startSection('title', 'Új könyv hozzáadása'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="published_year" name="published_year" value="<?php echo e(old('published_year')); ?>" 
                                       min="1000" max="<?php echo e(date('Y')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="total_copies" name="total_copies" value="<?php echo e(old('total_copies', 1)); ?>" 
                                       min="1" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?php $__errorArgs = ['available_copies'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="available_copies" name="available_copies" value="<?php echo e(old('available_copies', 1)); ?>" 
                                       min="0" required>
                                <?php $__errorArgs = ['available_copies'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/books/create.blade.php ENDPATH**/ ?>