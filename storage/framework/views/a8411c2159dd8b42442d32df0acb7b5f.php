...
<head>
    ...
    <title><?php echo e($book->title); ?> - BiblioTech</title>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="book-card p-4 position-relative">
                    ...
                    <!-- Book Info -->
                    <div class="text-center mb-4">
                        <h2 class="fw-bold text-dark mb-2"><?php echo e($book->title); ?></h2>
                        <h5 class="text-muted mb-3"><?php echo e($book->author->name); ?></h5>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <strong><?php echo e($book->category->name); ?></strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <strong><?php echo e($book->publication_year ?? 'N/A'); ?></strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <strong><?php echo e($book->available_copies); ?> / <?php echo e($book->total_copies); ?> elérhető</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><?php echo e(Str::limit($book->description, 150)); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <div class="text-center mt-4">
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-light btn-sm w-100">
                                <i class="bi bi-house"></i> Főoldal
                            </a>
                        </div>
                        <div class="col-6">
                            <a href="<?php echo e(route('books.index')); ?>" class="btn btn-outline-light btn-sm w-100">
...
<?php /**PATH /var/www/html/resources/views/qr/book-info.blade.php ENDPATH**/ ?>