                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-6 mb-3">
                            <div class="text-center p-3 border rounded <?php echo e($status ? 'bg-light-success' : 'bg-light-danger'); ?>">
                                <div class="mb-2">
                                    <?php if($status): ?>
                                ...
                                <h6 class="mb-1"><?php echo e(ucfirst(str_replace('_', ' ', $component))); ?></h6>
                                <small class="text-muted">
                                    <?php echo e($status ? 'Healthy' : 'Issue Detected'); ?>
            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature => $enabled): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span>
                                <i class="fas fa-<?php echo e($enabled ? 'check' : 'times'); ?> text-<?php echo e($enabled ? 'success' : 'danger'); ?> me-2"></i>
                                <?php echo e(ucfirst(str_replace('_', ' ', $feature))); ?>

                            </span>
                            <span class="badge bg-<?php echo e($enabled ? 'success' : 'secondary'); ?>">
                    ...
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <h4 class="text-primary mb-1"><?php echo e($recentActivity['new_books_today']); ?></h4>
                                <small class="text-muted">New Books Today</small>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <h4 class="text-info mb-1"><?php echo e($recentActivity['new_users_today']); ?></h4>
                                <small class="text-muted">New Users Today</small>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <h4 class="text-success mb-1"><?php echo e($recentActivity['borrows_today']); ?></h4>
                                <small class="text-muted">Borrows Today</small>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <h4 class="text-secondary mb-1"><?php echo e($recentActivity['returns_today']); ?></h4>
                                <small class="text-muted">Returns Today</small>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="border rounded p-3 <?php echo e($recentActivity['overdue_books'] > 0 ? 'bg-light-warning' : ''); ?>">
                                <h4 class="text-<?php echo e($recentActivity['overdue_books'] > 0 ? 'warning' : 'success'); ?> mb-1">
                                    <?php echo e($recentActivity['overdue_books']); ?>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="text-center p-3 border rounded">
                                ...
                                <h6>Database Size</h6>
                                <p class="mb-0 fw-bold"><?php echo e($performance['database_size']); ?></p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="text-center p-3 border rounded">
                                ...
                                <h6>Memory Usage</h6>
                                <p class="mb-0 fw-bold"><?php echo e($performance['memory_usage']); ?></p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="text-center p-3 border rounded">
                                ...
                                <h6>Storage Size</h6>
                                <p class="mb-0 fw-bold"><?php echo e($performance['storage_size']); ?></p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="text-center p-3 border rounded">
                                ...
                                <h6>Avg Response</h6>
                                <p class="mb-0 fw-bold"><?php echo e($performance['average_response_time']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm">
                            <tbody>
                                <?php $__currentLoopData = $configuration; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><strong><?php echo e(ucfirst(str_replace('_', ' ', $key))); ?></strong></td>
                                    <td>
                                        <code><?php echo e(is_bool($value) ? ($value ? 'true' : 'false') : $value); ?></code>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        <h2 class="text-danger mb-1"><?php echo e($errorSummary['recent']); ?></h2>
                        <small class="text-muted">Recent Errors (24h)</small>
                    </div>
                    <div class="mb-3">
                        <h4 class="text-secondary mb-1"><?php echo e($errorSummary['total']); ?></h4>
                        <small class="text-muted">Total Errors in Log</small>
                    </div>
                    <?php if($errorSummary['recent'] > 0): ?>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" value="<?php echo e(route('system.diagnostics')); ?>" readonly id="apiEndpoint">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/system-status.blade.php ENDPATH**/ ?>